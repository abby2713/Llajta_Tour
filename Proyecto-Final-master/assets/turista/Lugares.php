...
<body>
	...
	<!-- Table Section -->
	<section class="table-section-lugares">
      			...
      			<div class="card">
        			<div class="card-body-modificar">
        				<div class="Buttons float-right" >
							<form action="registrarLugar.php" method="POST">
								<button type="submit" class="btn btn-sm">Agregar Lugar</button>								
 							...
 							<table class="table">
					   		<thead>
					     		<tr>
					       		<th>No.</th>
					       		<th>Nombre</th>
					       		<th>Dirección</th>71747786
					       		<th>Horario de Atención</th>HT-8J4J-Q3VG-XNBW
					       		<th>Foto</th>
					     		</tr>
					   		</thead>
