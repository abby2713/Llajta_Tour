      			...
      			<div class="card">
        			<div class="card-body-modificar">
          				...
          				if(mysqli_num_rows($execonsulta)>0)
            			{
          				...
          				<form class="form-Modificar" action="modificarLugarbd.php" method="POST">            		
            				<input type="hidden" name="idLugar" class="form-control" value="<?php echo $idlugar; ?>"></input>
            				<br>
            				<div class="row">
            					<div class="col-md-6">
            						<label class="col-sm-5.5 col-form-label" for="form-control">Nombre</label>
            						<input type="text" name="nombreLugar" class="form-control" value="<?php echo $nombreLugar;?>"></input>
            					</div>
            					<div class="col-md-6">
            						<label class="col-sm-5.5 col-form-label" for="form-control">Dirección</label>
            						<input type="text" name="direccion" class="form-control" value="<?php echo $direccion;?>"></input>
            					</div>
            				</div> 
            					<label class="col-sm-4 col-form-label" for="form-control">Horario de Atención</label>
            					<input type="text" name="horarioAtencion" class="form-control" value="<?php echo $horarioAtencion; ?>"></input>
            					<label class="col-sm-4 col-form-label" for="">Foto</label>
            					<input type="text" name="foto" class="form-control" value="<?php echo $foto; ?>"></input>
            					<br>
            					<button type="submit" class="btn btn-primary">Modificar</button>
            					<a href="Lugares.php" class="btn btn-danger btn btn-sm">Cancelar</a>           				
          				</form>         
        			</div>
      			</div>
    		</div>
