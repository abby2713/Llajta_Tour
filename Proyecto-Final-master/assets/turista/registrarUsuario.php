	...
	<section class="form-section">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-12">
					<form class="Form-reg" action="registrarUsuariobd.php" method="POST">
            			<div class="row">
            				<div class="col-sm-6">
            					<label class="col-sm-8 col-form-label" for="">Apellido Paterno:</label>
            					<input type="text" name="apellidoPaterno" class="form-control" required placeholder="[A-Za-z]+"></input>
            				</div>
            				<div class="col-sm-6">
            					<label class="col-sm-8 col-form-label" for="">Apellido Materno:</label>
            					<input type="text" name="apellidoMaterno" class="form-control" required></input>
            				</div>           				
            			</div>            			
            			<label class="col-sm-12 col-form-label" for="">Nombres:</label>
            			<input type="text" name="nombres" class="form-control" required></input>
            			<div class="row">
            				<div class="col-sm-6">
            					<label class="col-sm-12 col-form-label" for="">Login:</label>
            					<input type="text" name="login" class="form-control" required></input>
            				</div>
            				<div class="col-sm-6">
            					<label class="col-sm-12 col-form-label" for="">Password:</label>
            			...
            			<a href="IAdmin.php" class="btn btn-danger btn btn-sm ">Cancelar</a>
          			</form>
				</div>
			</div>
		</div>
