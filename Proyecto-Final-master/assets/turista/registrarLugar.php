	...
	<section class="form-section">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-12">
					<form class="Form-reg" action="registrarLugarbd.php" method="POST" enctype="multipart/form-data">
            			<div class="row">
            				<div class="col-sm-6">
            					<label class="col-sm-8 col-form-label" for="">Nombre:</label>
            					<input type="text" name="nombreLugar" class="form-control" pattern="[a-z]+[A-Z]+" required></input>
            				</div>
            				<div class="col-sm-6">
            					<label class="col-sm-8 col-form-label" for="">Dirección:</label>
            					<input type="text" name="direccion" class="form-control" required></input>
            				</div>           				
            			</div>
            			<div class="row">
            				<div class="col-sm-6">
            					<label class="col-sm-12 col-form-label" for="">Horario de Atención:</label>
            					<input type="text" name="horarioAtencion" class="form-control"></input>
            				</div>
            				<div class="col-sm-6">
            					<label class="col-sm-12 col-form-label" for="">Foto:</label>
            					<input type="file" accept="image/*" name="foto" class="form-control"></input>
            				</div>           				
            			</div> 
